...
public class EdgeServer {
  ...
  private StateMigration stateMigrationService;
...
//    LOGGER.info("Started edge server ...");
    stateMigrationService = new StateMigration();
    BandwidthEstimator bandwidthEstimator = new BandwidthEstimator();  // TODO: use Singleton Pattern
    SensorDataHandler sensorDataHandler = new EmpReapSensorDataHandler(bandwidthEstimator, algorithmId, savePath, stateMigrationService);
...
//    int numClient = 1;
//    config.numClient = numClient;
//    int algorithmId = 2;
//    config.algorithmId = algorithmId;
//    String savePath = "/home/apphandover/emp/EMP";
