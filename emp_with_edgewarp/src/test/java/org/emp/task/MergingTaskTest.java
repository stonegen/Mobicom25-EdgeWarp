...
public class MergingTaskTest extends EmpUnitTest {
    ...
    public void testRunMergingTask() throws InterruptedException {
        ...
        StateMigration stateMigrationService = new StateMigration();
        SensorDataHandler sensorDataHandler = new EmpReapSensorDataHandler(bandwidthEstimator, 0, null, stateMigrationService);
