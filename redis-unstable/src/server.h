...
#include "tpool.h" /* thread pool abstraction*/
#include "spool.h" /* single threaded pool abstraction*/
...
// --> globally making the threadpool queue acccessible :
extern tpool_t *tm;
extern tpool_t *tm2;
extern dedicated_thread_t *dt;
